package com.lock.fixie.Fragments;
...
public class MenuprincipalFragment extends Fragment {
    ...
    View vista;
    Activity actividad;
    CardView cardImagenes, cardRegistros, cardAjustes, cardPerfil;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        vista = inflater.inflate(R.layout.fragment_menuprincipal, container, false);
        cardImagenes = vista.findViewById(R.id.cardImagenes);
        cardRegistros = vista.findViewById(R.id.cardRegistros);
        cardAjustes = vista.findViewById(R.id.cardAjustes);
        cardPerfil = vista.findViewById(R.id.cardRegistros);
    ...
    public void eventosMenu(){
        cardImagenes.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                intefaceComunicaFragments.Imagenes();
        ...
        cardRegistros.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                intefaceComunicaFragments.Registros();
        ...
        cardAjustes.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                intefaceComunicaFragments.Perfil();
        ...
        cardPerfil.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                intefaceComunicaFragments.Ajustes();
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof Activity) {
            ...
            intefaceComunicaFragments = (IComunicaFragments) actividad;
        }
